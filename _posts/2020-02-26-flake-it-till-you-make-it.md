...
I don't understand what's so important about $$\mathbb{N}$$. It's not particularly interesting algebraically. Many number systems (such as $$latex \mathbb{Z}, \mathbb{Q}, \mathbb{R}, \mathbb{C}$$) are groups, but $$latex \mathbb{N}$$ isn't, as it doesn't have inverses. Heck, $$(\mathbb{N}, +)$$ isn't even a monoid, as it doesn't include $$0$$.
